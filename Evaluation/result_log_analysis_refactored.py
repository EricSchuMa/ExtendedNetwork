...
def main(merged_data_filename, result_log_filename, nodes_extra_info_filename, terminal_dict, preprocess=True):
    ...
    terminal_dict_df = pd.read_pickle(terminal_dict)
    terminal_dict_size = terminal_dict_df.shape[0]
